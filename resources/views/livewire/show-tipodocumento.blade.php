                ...
                <tbody>
                    @foreach ($tipodocumentos as $tipodocumento)
                        <tr>
                            ...
                            <td>{{ $tipodocumento->created_at->toFormattedDateString() }} -
                                {{ $tipodocumento->updated_at->toFormattedDateString() }}</td>
                            ...
                            <td width="4px">
                                <div class="btn-group">
                                    @can('admin.tipodocumentos.estatutipodocumento')
                                        <a type="button" class="btn btn-default btn-sm"
                                            style="border-color: rgb(158, 157, 157)">
                                            @if ($tipodocumento->estatus == 1)
                                                <form class="formulario-estatus"
                                                    action="{{ route('admin.tipodocumentos.estatutipodocumento', $tipodocumento) }}"
                                                    method="get">
                                                    @csrf
                                                    <button type="submit"
                                    ...
                                    @endcan
                                    @can('admin.tipodocumentos.destroy')
                                        <a type="button" class="btn btn-default btn-sm"
                                            style="border-color: rgb(158, 157, 157); border-top-left-radius: 0px; border-bottom-left-radius: 0px;">
