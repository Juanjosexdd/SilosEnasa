    ...
    <x-card-body>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="input-group">
                    {!! Form::select('requisicion_id', $requisicions, null, ['class' => 'form-control  select2' . ($errors->has('requisicion_id') ? ' is-invalid' : ''), 'data-live-search' => 'true', 'placeholder' => '']) !!} {{-- <button type="button" class="btn bg-navy elevation-4 ml-1" style="border-radius: 100%"><i class="fas fa-plus"></i></button> --}}
